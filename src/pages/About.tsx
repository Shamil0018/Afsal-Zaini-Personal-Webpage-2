            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <AnimatedSection delay={0.2}>
                <div className="relative">
                  ...
                  >
                    <p className="text-primary font-display font-semibold text-lg">Business Development</p>
                    <p className="text-foreground text-sm">Specialist & Strategist</p>
                  </motion.div>
                </div>
              </AnimatedSection>
            </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <AnimatedSection className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-8">
                Transforming Entrepreneurs, <span className="text-gradient">One Business at a Time</span>
              </h2>
